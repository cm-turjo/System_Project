...
def print_tables(doc):
    ...
    directory_path = 'D:/Academic/System Final/Solution'
...
def excel_add(cteacher):
    workbook = openpyxl.load_workbook('D:\\Academic\\System Final\\imransirdemo.xlsx')
    name_string = "নাম: "
    podobi_string = "পদবী: "
    ...
    loaded_workbook.save(f'D:/Academic/System Final/Solution/{file_name}')
    
    
    workbook = openpyxl.load_workbook(f'D:/Academic/System Final/Solution/{file_name}')
    sheet = workbook.active
...
def main():
    doc_path = 'D:/Academic/System Final/new bill.docx'
